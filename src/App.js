...
function App() {
  ...
  const baseURL = `http://sandbox-api.lomadee.com/v2/${lomadeeAppToken}/coupon/_all?sourceId=${lomadeeSourceId}&storeId=5800`;
  ...
  useEffect(() => {
    axios
      .get(
        `http://sandbox-api.lomadee.com/v2/${lomadeeAppToken}/coupon/_all?sourceId=${lomadeeSourceId}`
      )
